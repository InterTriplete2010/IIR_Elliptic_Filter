...
This code calculate the coefficients of the Band-pass, Band-stop, Low-pass and High-pass Elliptic filters. The file Elliptic_Filter.cpp can be used to test the code. It also filters the data, but no zero-phase delay is applied. The name space is: IIR_E_F.
